export function renderHeroSection() {
  ...
  `;
  section.style.backgroundImage = "url('./assets/bg-hero.webp')"; // ganti path sesuai gambar bg kamu
  ...
  // === Tambahkan gambar bawah center ===
  const bottomImage = document.createElement('img');
  bottomImage.src = './assets/content-hero.webp'; // ganti sesuai file kamu
